    ...
    <body>
       ...
       <nav class='z-depth-3 col s12'>
                 ...
                 <div class="row">
                    ...
                    <div id="add" class="col s12">
                        <div class="col s12 m12 l10 offset-l1">
                            <div class="row">
                                <form name='add-rst' method='post' id='add-rst' class="col s12">
                                <div class="row">
                                ...
                                <div class='col s12 l12 center'><button name='submit' class="waves-effect waves-light btn z-depth-2 black-btn">Add Restaurant</button></div>
        ...
        E                </div>
                         ...
                         <form name='review-accept' method="post" id='review-accept'>
                             ...
                             <?php 
                                ...
                                while($row = $sql->fetch()){
                                    ...
                                    echo "<input type='checkbox' name='".$row['ar_id']."' id='".$row['ar_id']."'>";
                    ...
                    <div id="edit" class="col s12">Edit restaurants here</div>
                    <div id="delete" class="col s12">Delete restaurants</div>
