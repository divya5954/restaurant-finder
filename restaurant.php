					 ...
					 <div class='row'>
							 <div class='col m2 card sidebar z-depth-2'>
									 ...
									 <div class='col m12 filters'>
												...
												<h5>Veg / Non-Veg </h5>
												<ul>
													<li><a href="restaurant.php?type=veg"><font size="3">Vegetarian</font></a></li>
													<li><a href="restaurant.php?type=nveg"><font size="3">Non-Vegetarian</font></a></li>
												</ul>
												<h5>Sort by</h5>
												<ul>
												<li><a href="restaurant.php?sort=ca"><font size="3">Cost - Low to high</font></a></li>
												<li><a href="restaurant.php?sort=cd"><font size="3">Cost - High to low</font></a></li>
												<li><a href="restaurant.php?sort=rating"><font size="3">Rating - High to low</font></a></li>
												</ul>
												<h5>Cuisines</h5>
												<ul>
													<?php 
														...
														while($row=$sql->fetch()){
															echo '<li><a href="restaurant.php?cuisine='.$row['r_cuisine'].'"><font size="3">'.$row['r_cuisine'].'</font></li>';
														}
													?>
												</ul>
