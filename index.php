...
if($_POST["email"]=="admin@restro.com" && $_POST["password"] == "12345"){
	...
	//header('Location: #'); //idk where to go from here.
	exit();
	//}
}
            ...
            <div class="nav-wrapper">
                ...
                <ul id="nav-mobile" class="right">
					...
					/*	echo '<form action="" method="post" id="logout" name="logout" >';
						...
						echo '</form>';
					*/	echo '<li class="waves-effect waves-light"><a href="logout.php" name="logout" class="waves-effect waves-light btn modal-trigger z-depth-2 red">Logout</a></li>';
					}
					else
					{
